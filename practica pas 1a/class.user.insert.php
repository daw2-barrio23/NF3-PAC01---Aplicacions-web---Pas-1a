...
class User {
    ...
    public function Save() {
                if (isset($this->ID)) {
                        ...
                        $objStatement->execute();
                        logMessage('Elemento ' . $this->ID . ' actualizado', NOTICE);
                } else {
                        $strValueList = "";
                        ...
                        logMessage('Elemento ' . $this->ID . ' insertado', DEBUG);
                }
        }
        ...
        private function SetAccessor($strMember, $strNewValue) {
                if (property_exists($this, $strMember)) {
                        ...
                        logMessage('Actualiza valor ' . $strMember, CRITICAL);
                } else {
                        return(false);
                };
        ...
        private function GetAccessor($strMember) {
                if (property_exists($this, $strMember)) {
                        ...
                        logMessage('Recibe valor ' . $strMember, WARNING);
                        return($strRetVal);
                } else {
                        return(false);
                };
